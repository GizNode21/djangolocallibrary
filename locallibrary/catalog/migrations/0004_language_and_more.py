# Generated by Django 4.2.16 on 2024-09-17 03:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. English, French, Japanese).", max_length=200, unique=True)),
            ],
        ),
